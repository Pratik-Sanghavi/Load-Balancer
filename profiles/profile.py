...
# Nginx Load Balancer
load_balancer.addService(rspec.Execute(shell="sh", command="mkdir /users/prsangh/logs/nginx"))
load_balancer.addService(rspec.Execute(shell="sh", command="mkdir /users/prsangh/nginx_config"))
...
load_balancer.addService(rspec.Execute(shell="sh", command="mkdir /users/prsangh/logs/haproxy"))
load_balancer.addService(rspec.Execute(shell="sh", command="mkdir /users/prsangh/haproxy_config"))
